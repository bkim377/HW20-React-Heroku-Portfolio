              ...
              <div class="col-sm-1"></div>
                <div class="col-sm-10">
                    ...
                    <div class = "card-body">
                        ...
                        <h5>My Email: bkim377@gatech.edu</h5>
                        <br></br>
                        ...
                        <br></br>
                        <form action="sms://+17705577499" method="post" enctype="application/x-www-form-urlencoded">
                        <button type="submit" class="btn btn-success">Text Me</button>
                        </form>
